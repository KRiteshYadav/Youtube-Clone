package com.spring.ritesh.youtubeclone.service;
...
public class S3Service implements  FileService{
    ...
    public static final String BUCKET_NAME = "youtubecloneriteshbucket";
    ...
    try {
        ...
        throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"AN EXCEPTION OCCURED WHILE UPLOADING THE FILE TO S3");
    }
